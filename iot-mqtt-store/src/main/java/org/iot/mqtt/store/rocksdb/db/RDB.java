package org.iot.mqtt.store.rocksdb.db;
...
import org.iot.mqtt.test.utils.MixAll;
...
public class RDB {
    ...
    public void init(){
        this.DB_OPTIONS.setCreateIfMissing(true)
                ...
                .setMaxBackgroundFlushes(this.mqttConfig.getMaxBackgroundFlushes())
                .setMaxBackgroundCompactions(this.mqttConfig.getMaxBackgroundCompactions())
